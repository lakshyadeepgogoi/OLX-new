...
function FurnituresAdCards() {
    ...
    useEffect(() => {
        const fetchAds = async () => {
            try {
                const adsCollectionRef = collection(db, 'categories', 'Furnitures', 'ads');
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 md:gap-5 xl:gap-6 w-[90%] m-auto">
            {loading ? (
...
export default FurnituresAdCards;
