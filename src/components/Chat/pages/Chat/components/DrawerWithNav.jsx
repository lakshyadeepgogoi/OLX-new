...
export function DrawerWithNav(props) {
    ...
    >
                ...
                <ListItemButton
                  ...
                  <ListItemIcon
                    ...
                    <StyledBadge
                      ...
                      >
                      <Avatar alt="" src={item?.data?.photoURL} />
                    </StyledBadge>
                  </ListItemIcon>
                  <ListItemText
                    primary={item?.data?.displayName || item?.data?.name?.split(' ')[0]}
                    sx={{
                      opacity: open ? 1 : 0,
                    }}
                    />
      ...
      >
        <Toolbar>
          ...
          <Avatar alt="" src={Logo} sx={{ width:150, height: 50, borderRadius: 0 }}/>
  ...
  >
    <Tooltip title="Open settings">
      ...
      >
        {user && user.photoURL && <Avatar alt={user.displayName} src={user.photoURL} />}
      </IconButton>
    </Tooltip>
    <Menu
      sx={{
    ...
    >
      {myObject && (
        <MenuItem onClick={handleCloseUserMenu}>
          <Typography textAlign="center">{myObject.name}</Typography>
        </MenuItem>
      )}
      <MenuItem
        onClick={() => {
