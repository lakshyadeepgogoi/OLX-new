...
function SportsgymsForm({ nextStep, previousStep, selectedCategory }) {
  ...
  const [category, setCategory] = useState('');
    ...
    const handleCategoryChange = (event) => {
        ...
        switch (selectedCategory) {
            ...
            case 'Outdoor Games':
                setSubcategoryOptions(['Outdoor Games']);
                break;
            case 'Indoor Game':
                setSubcategoryOptions(['Indoor Game']);
                break;
            case 'Gym Equipment':
                setSubcategoryOptions(['Gym Equipment']);
                break;
            case '':
                setSubcategoryOptions(['Other spare parts']);
                break;
    ...
    const handleNextClick = async (event) => {
        ...
        try {
            ...
            const sportsgymDocRef = await addDoc(adsCollectionRef, {
                selectedCategory,
                userId,
                category,
                subcategory,           
            ...
            const docId = sportsgymDocRef.id;
    ...
    <form onSubmit={''} className="flex flex-col w-full gap-y-4 mt-6">
        ...
        <label className='w-full relative'>
            ...
            >
                ...
                <option value="Gyms Equipment">Gym Equipment</option>
