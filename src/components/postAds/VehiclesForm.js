...
import { db } from '../../pages/firebase';  // Ensure this path is correct for your Firebase setup
import { collection, addDoc, serverTimestamp } from 'firebase/firestore';

function VehiclesForm({ nextStep }){
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const vehicleDocRef = await addDoc(vehiclesCollection, {
                subcategory,
                brand,
                model,
                adName,
            ...
            const collectionId = vehiclesCollection.id;
