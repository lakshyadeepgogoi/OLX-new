...
function SparepartsForm({ nextStep, previousStep, selectedCategory }) {
    ...
    const handleCategoryChange = (event) => {
        ...
        switch (selectedCategory) {
            ...
            case 'Wheels and Tyres':
                setSubcategoryOptions(['Wheels and Tyres']);
                break;
            case 'Audio & Other Accessories':
                setSubcategoryOptions(['Audio & Other Accessories']);
                break;
    ...
    const handleNextClick = async (event) => {
        ...
        try {
            ...
            const sparepartsDocRef = await addDoc(adsCollectionRef, {
                selectedCategory,
                userId,
                category,
                subcategory,
            ...
            const docId = sparepartsDocRef.id;
