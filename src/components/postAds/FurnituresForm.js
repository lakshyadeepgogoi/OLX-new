...
function FurnituresForm({ nextStep, previousStep, selectedCategory }) {
    ...
    const handleCategoryChange = (event) => {
        ...
        switch (selectedCategory) {
            ...
            case 'Home Furnishing':
                setSubcategoryOptions(['Bed Linens', 'BedSheets', 'Table Linen Sets', 'Sofa & Curtain fabric']);
                break;
            case 'Living Room Furnishing':
                setSubcategoryOptions(['Sofas Sets & Secionals', 'TV Unit', 'Dining Set', 'Sofa Beds']);
                break;
            case 'Kitchen & Dining':
                setSubcategoryOptions(['Cookware', 'Knives,Choppers & Cutter', 'Outdoor Cooking', 'Containers & kitchen storage']);
                break;
            case 'Bedroom Furniture':
                setSubcategoryOptions(['Beds', 'office chair', 'TV Unit', 'Mattress']);
                break;
            case 'Cleaning & Bath':
                setSubcategoryOptions(['Cleaning Supplies', 'Air fresheners', 'Taps & Faucet', 'Toothbrush holder']);
                break;
            default:
    ...
    const handleNextClick = async (event) => {
        ...
        try {
            ...
            const furnitureDocRef = await addDoc(adsCollectionRef, {
                selectedCategory,
                userId,
                category,
                subcategory,
            ...
            const docId = furnitureDocRef.id;
            ...
            <form onSubmit={''} className="flex flex-col w-full gap-y-4 mt-6">
                ...
                <label className='w-full relative'>
                    ...
                    >
                        ...
                        <option value="Living Room Furnishing">Living Room Furnishing</option>
                        <option value="Kitchen & Dining">Kitchen & Dining</option>
                        <option value="Bedroom Furniture">Bedroom Furniture</option>
                        <option value="Cleaning & Bath">Cleaning & Bath</option>
                    </select>
                </label>
                ...
                <div className='grid grid-cols-2 gap-4'>
                    ...
                    <label className='w-full'>
                        ...
                        <input
                            ...
                            placeholder="Enter Age of the item"
                            className='bg-gray-100 rounded-md text-gray-800 w-full px-4 py-2'
                        />
                    </label>
                </div>
