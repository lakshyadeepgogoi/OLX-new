...
function PetsForm({ nextStep, previousStep, selectedCategory }) {
    ...
    const handleSubcategoryChange = (event) => {
        ...
        switch (selectedSubcategory) {
            ...
            case 'Fishes & Aquarium':
                setBrandOptions(['fish', 'Aquarium', 'fish food', 'Other']);
                break;
            case 'Pet Food & Accessories':
                setBrandOptions(['pet food', 'pet Accessories', 'other']);
                break;
            case 'Dogs':
                setBrandOptions(['jerman seaford', 'labrador', 'other Dogs breed']);
                break;
            case 'Other Pets':
                setBrandOptions(['Cats', 'Birds', 'other',]);
                break;
            default:
                setBrandOptions([]);
                break;
        ...
        <div>
            <form onSubmit={''} className="flex flex-col w-full gap-y-4 mt-6">
                ...
                <div className='grid grid-cols-2 gap-4'>
                    <label className='w-full'>
                        <p className='text-sm text-gray-800 mb-1'>
                            Pet and Items <sup className='text-pink-200'>*</sup>
                        </p>
                        <select
                            required
                            value={brand}
